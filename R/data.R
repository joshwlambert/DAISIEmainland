#' Parameter space for the general analysis of the DAISIE mainland extinction
#' model.
#'
...
#'
#' @format A data frame with 960 rows and 10 variables:
#' \describe{
...
#' }
#' @usage data("general_param_space", package = "DAISIEmainland")
"general_param_space"

#' Parameter space for the analysis of changing the mainland extinction rate in
#' the DAISIE mainland extinction model.
#'
#' A dataset containing the parameter sets (rows) for the simulation of the
#' DAISIE mainland extinction model for the analysis of the error inferred by
#' DAISIE's maximum likelihood model.
...
#'   \item{replicates}{Number or island replicates}
#' }
#' @usage data("mainland_ex_param_space", package = "DAISIEmainland")
"mainland_ex_param_space"

#' Parameter space for the analysis of changing the mainland sampling
#' probability in the DAISIE mainland extinction model.
#'
#' A dataset containing the parameter sets (rows) for the simulation of the
#' DAISIE mainland extinction model for the analysis of the error inferred by
#' DAISIE's maximum likelihood model.
...
#'   \item{replicates}{Number or island replicates}
#' }
#' @usage data("mainland_sample_prob_param_space", package = "DAISIEmainland")
"mainland_sample_prob_param_space"
