---
title: "Summary metrics visualisation"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Summary metrics visualisation}
...
```{r}
delta_ctt <- DAISIEmainland:::calc_ctt(daisie_data = island)
delta_ctt
```

```{r}
max_age_percent <- DAISIEmainland:::calc_max_age_percent(daisie_data = island)
max_age_percent
```

```{r}
endemic_percent <- DAISIEmainland:::calc_endemic_percent(daisie_data = island)
endemic_percent
```
