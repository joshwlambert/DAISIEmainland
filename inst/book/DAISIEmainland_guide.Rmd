...
<!--chapter:end:simulation_algorithm.Rmd-->
...
<!--chapter:end:simulation_data_visualisation.Rmd-->
...
<!--chapter:end:inference_performance.Rmd-->
...
<!--chapter:end:summary_metrics_visualisation.Rmd-->
...
<!--chapter:end:data_standards.Rmd-->
