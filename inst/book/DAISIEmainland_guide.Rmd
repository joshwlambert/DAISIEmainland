...
The previous section (Section \@ref(simulation-algorithm)) showed how the data is simulated. Another important aspect visualising the data and `DAISIEmainland`
...
`DAISIEmainland/scripts/run_analysis.R` in the `DAISIEmainland` package. 
...
of mainland extinction. Each of the boxplots below is obtained from 100 island replicates.
...
package can be found at `DAISIEmainland/scripts/joss_data_vis.R` and `DAISIEmainland/scripts/evolution_data_vis.R`, 
respectively, in the `DAISIEmainland` package.

<!--chapter:end:summary-error-metrics-visualisation.Rmd-->
