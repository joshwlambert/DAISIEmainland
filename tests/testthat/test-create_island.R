# PN: We checked the expectations together, should be correct.
...
# PN: This test is, I think correct, but we didn't check the expectations
# together
# test_that("mainland ancestor sister is extant, mainland ancestor is extinct;
#           multiple colonists same species; clado event", {
#   set.seed(1)
#   total_time <- 1
#
