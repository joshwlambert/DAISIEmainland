test_that("calc_error runs without error", {
  ...
  expect_equal(error$param_diffs$clado_diffs, 1.12244897959)
  expect_equal(error$param_diffs$ext_diffs, 1.64)
  expect_equal(error$param_diffs$k_diffs, 4)
  expect_equal(error$param_diffs$immig_diffs, 1.33333333333)
  expect_equal(error$param_diffs$ana_diffs, 1.05263157895)
