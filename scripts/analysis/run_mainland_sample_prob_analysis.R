...
ideal_sim_metrics <- vector("list", mainland_sample_prob_param_space$replicates[args])
empirical_sim_metrics <- vector("list", mainland_sample_prob_param_space$replicates[args])
